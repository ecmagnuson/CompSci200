...
public class MysteryMethods {
    ...
    /**
     * This main method creates a char array and manipulates it by calling four
     * methods. It prints out the array, calls a method to return the index of char
     * 'e' and 'g' and then another method to swap their places. It then prints out
     * a reversed char array after calling a method that reverses it. Finally, it
     * calls two more methods that count the amount of each alphabet chars present
     * in the array, and then prints it out with a description.
     * 
     * @param args not used.
     */
